...
export const DEFAULT_RECIPES: RecipeCard[] = [
  {
    ...
    steps: [
      'Hefe im lauwarmen Wasser auflÃ¶sen, dann alle Zutaten kurz mit einem LÃ¶ffel verrÃ¼hren (nicht kneten).',
      'Teig abgedeckt 8â€“12 Stunden im KÃ¼hlschrank reifen lassen.',
      'Topf (Gusseisen oder ofenfest) im Ofen auf 250 Â°C Ober-/Unterhitze vorheizen.',
      'Teig auf bemehltes Backpapier stÃ¼rzen, Ã¼ber die Seiten falten und mit Papier in den heiÃŸen Topf setzen.',
